    ...
    public class VaccinationRecordController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                return Ok(new { success = true, message = "Lấy danh sách hồ sơ tiêm chủng thành công", data = records });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            try
            {
                ...
                return Ok(new { success = true, message = "Lấy thông tin hồ sơ tiêm chủng thành công", data = record });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Create([FromBody] CreateVaccinationRecordDto dto)
        {
            try
            {
                ...
                return CreatedAtAction(nameof(GetById), new { id = record.Id }, new { success = true, message = "Tạo hồ sơ tiêm chủng thành công", data = record });
            }
            catch (Exception ex)
            {
                return BadRequest(new { success = false, message = ex.Message });
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateVaccinationRecordDto dto)
        {
            try
            {
                ...
                return Ok(new { success = true, message = "Cập nhật hồ sơ tiêm chủng thành công", data = record });
            }
            catch (Exception ex)
            {
                return BadRequest(new { success = false, message = ex.Message });
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            try
            {
                ...
                return Ok(new { success = true, message = "Xóa hồ sơ tiêm chủng thành công" });
            }
            catch (Exception ex)
            {
                return BadRequest(new { success = false, message = ex.Message });
