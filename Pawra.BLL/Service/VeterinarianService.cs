...
namespace Pawra.BLL.Service
{
    public class VeterinarianService : IVeterinarianService
    {
        ...
        {
            var veterinarian = await _context.Veterinarians.AsNoTracking().FirstOrDefaultAsync(v => v.Id == id);
            if (veterinarian == null) throw new NotFoundException($"Không tìm thấy bác sĩ thú y với ID: {id}");
