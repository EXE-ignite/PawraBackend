        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicManagers_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicManagers_Accounts_AccountId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionAccounts_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubscriptionAccounts_SubscriptionPlans_SubscriptionPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clinics_ClinicManagers_ClinicManagerId",
                        column: x => x.ClinicManagerId,
                        principalTable: "ClinicManagers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicVaccines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicVaccines_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicVaccines_Vaccines_VaccineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veterinarians_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Admin", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Customer", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "Veterinarian", null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, "ClinicManager", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicManagers_AccountId",
                table: "ClinicManagers",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClinicManagers_AccountId1",
                table: "ClinicManagers",
                column: "AccountId1",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicVaccines_ClinicId",
                table: "ClinicVaccines",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicVaccines_VaccineId",
                table: "ClinicVaccines",
                column: "VaccineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_ServiceId",
                table: "Prescriptions",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionAccounts_AccountId",
                table: "SubscriptionAccounts",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionAccounts_SubscriptionPlanId",
                table: "SubscriptionAccounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Veterinarians_AccountId",
                table: "Veterinarians",
                column: "AccountId",
                unique: true);
